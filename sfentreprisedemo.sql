...
CREATE DATABASE IF NOT EXISTS `sfentreprisedemo` /*!40100 DEFAULT CHARACTER SET latin1 */ /*!80016 DEFAULT ENCRYPTION='N' */;
...
REPLACE INTO `doctrine_migration_versions` (`version`, `executed_at`, `execution_time`) VALUES
	('DoctrineMigrations\\Version20230717121859', '2023-07-17 12:20:46', 301);
...
REPLACE INTO `employe` (`id`, `entreprise_id`, `nom`, `prenom`, `date_naissance`, `date_embauche`, `ville`) VALUES
	(1, 1, 'SMAIL', 'Stephane', '1982-07-18 11:37:14', '2019-07-18 11:37:25', 'MULHOUSE'),
	(2, 1, 'MATHIEU', 'Quentin', '1997-07-18 11:37:56', '2022-07-18 11:38:02', NULL),
	(3, 1, 'MURMANN', 'Mickael', '1985-07-18 11:38:28', '2010-07-18 11:38:35', NULL),
	(4, 2, 'ANDRES', 'Mathilde', '1994-07-18 11:39:08', '2015-07-18 11:39:20', NULL);
...
REPLACE INTO `entreprise` (`id`, `raison_sociale`, `date_creation`, `adresse`, `cp`, `ville`) VALUES
	(1, 'ELAN FORMATION', '2023-07-17 15:50:42', '14 rue du Rhone', '67100', 'STRASBOURG'),
	(2, 'COACTIS', '2023-07-17 15:52:12', '10 rue de la Charnille', '67200', 'STRASBOURG'),
	(3, 'OUIDOU', '2023-07-17 15:53:13', '1 rue principale', '68000', 'COLMAR');
